...
IDiagram diagram = new Diagram()
                   .Vpc(vpcName: "vpc-1", config: vpc =>
                   {
                     vpc.Ec2(instanceName: "ec2-X")
                        ...
                        .Ec2(instanceName: "ec2-6",
                             connectTo: "ec2-1")
                        .Ec2(instanceName: "ec2-7",
                             connectTo: "ec2-2")
                        .Ec2(instanceName: "ec2-8",
                             connectTo: "ec2-2")
                   ...
                   .Ec2(instanceName: "ec2-12", connectTo: "ec2-11")
                   .Ec2(instanceName: "ec2-13", connectTo: "ec2-11")
                   .Ec2(instanceName: "ec2-14", connectTo: "ec2-11")
                   .Ec2(instanceName: "ec2-15", connectTo: "ec2-11")
                   .Ec2(instanceName: "ec2-16", connectTo: "ec2-15")
                   .Ec2(instanceName: "ec2-17", connectTo: "ec2-11")
                   .Ec2(instanceName: "ec2-18", connectTo: "ec2-11")
                   .Ec2(instanceName: "ec2-19", connectTo: "ec2-11")
                   .Ec2(instanceName: "ec2-20", connectTo: "ec2-11")
                   .Render();
